...
class mitarbeiter extends benutzer
{
	 ...
	 * @return boolean
	 */
	public function getMitarbeiterStg($lektor,$fixangestellt, $stge, $fkt_kurzbz, $order = 'studiengang_kz, nachname, vorname, kurzbz', $datum_von = '', $datum_bis = '')
	{
     ...
     * @return boolean
     */
    public function getMitarbeiterForZutrittskarte($filter, $fixangestellt, $studSemArray)
    {
        $qry = "SELECT
