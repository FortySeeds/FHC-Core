...
class Vertrag_model extends DB_Model
{
	...
	private function _writeVertragsbezeichung($lehrveranstaltung_id, $studiensemester_kurzbz)
	{
		...
		$this->LehrveranstaltungModel->addSelect(
			...
			lehrform_kurzbz,
			public.tbl_studiengang.typ,
			public.tbl_studiengang.kurzbz'
		);
		...
		$this->LehrveranstaltungModel->addJoin(
			'public.tbl_studiengang',
			'public.tbl_studiengang.studiengang_kz = lehre.tbl_studienordnung.studiengang_kz'
		);
